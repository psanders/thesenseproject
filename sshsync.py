...
hostname = '109.123.121.183' # remote hostname where SSH server is running
port = 22
username = 'psanders'
password = 'osopolar'
rsa_private_key = '/home/pi/.ssh/rsa_private_key'

dir_local = '/home/pi/thesenseproject/data'
dir_remote = '/var/www/thesenseproject/'
glob_pattern = '*.*'
